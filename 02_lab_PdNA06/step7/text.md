...
`ps` nos informa sobre los procesos existentes cuando ejecutamos la orden.
Por sí solo no reconstruye qué procesos se estaban ejecutando en un momento
anterior.
...
Antes de terminar, deberá aplicar conjuntamente las ideas de esta práctica a
una última cuestión del caso.

Pulse **NEXT** cuando esté preparado.
